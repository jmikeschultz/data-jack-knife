 ...
 *
 */
public class InnerJsonFormatParser extends FileFormatParser {
     ...
     * @throws IOException
     */
    InnerJsonFormatParser() throws IOException {
        this(null);
    }
     ...
     * @throws IOException
     */
    public InnerJsonFormatParser(JsonReader jsonReader) throws IOException {
    ...
    public Object replicate() throws IOException {
        return new InnerJsonFormatParser();
    }
