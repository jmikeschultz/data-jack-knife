...
import com.amazon.djk.pipe.PopPipe;
import com.amazon.djk.pipe.PushPipe;
...
public class DataJackKnife extends JackKnife {
    ...
    public DataJackKnife() throws DJKInitializationException {
        ...
        registerOp(PopPipe.Op.class);
        registerOp(PushPipe.Op.class);
